...
export default function Footer() {
  return (
    <footer className="bg-muted text-muted-foreground pt-16 pb-8 relative z-10 border-t border-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="#bookkeeping" className="hover:text-blue-600 transition-colors">
                  Bookkeeping Services
                </Link>
              </li>
              <li>
                <Link href="#payroll" className="hover:text-blue-600 transition-colors">
                  Payroll Services
                </Link>
              </li>
              <li>
                <Link href="#tax" className="hover:text-blue-600 transition-colors">
                  Tax Preparation
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="#virtual" className="hover:text-blue-600 transition-colors">
                  Virtual Bookkeeper
                </Link>
              </li>
            </ul>
